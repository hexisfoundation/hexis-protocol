...
<p class="sub">Proof of Integrity v0.4 · hexisfoundation.org · <a href="/docs">docs</a></p>
...
return jsonify({“service”:“HEXIS Trust API”,“version”:“0.4”,
...
init_db()
print(”=”*56)
print(“HEXIS Trust API v0.4 - with SQLite + API keys”)
print(”=”*56)
